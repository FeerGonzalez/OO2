package ar.unrn.tp4.eje3.infraestructure.data;
...
import ar.unrn.tp4.eje3.domain.portsout.ConcursoRecord;
	...
	public List<ConcursoRecord> leer() {
		...
		try {
            ...
            while ((cadena = bufferReader.readLine()) != null) {
                ...
                ConcursoRecord concurso = new ConcursoRecord(id, nombre, fechaInicioInscripcion, fechaCierreInscripcion);
                lista.add(concurso);
            }
